...
//extern "C"{
//#endif
   int c_runApp(char * dir, int proc_x, int proc_y, int proc_z, MPI_Comm comm, bool isCompG, 
            bool isRepeatComb, int nDoubles, int nx, int ny, int nz, int n_comb, bool isRealCall);
